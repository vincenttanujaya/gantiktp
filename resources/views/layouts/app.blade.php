...
<head>
    ...
    <title>Admin Pergantian KTP</title>
...
<body style="background-color:#1c4b82">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light" style="background-color:#1c4b82">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}" style="color:white">
                    Admin Pergantian KTP
                </a>
